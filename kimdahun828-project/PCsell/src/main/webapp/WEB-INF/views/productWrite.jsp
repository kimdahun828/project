					...
					<div class="col-md-3">
						<div class="header-logo">
							<a href="${ path }/" class="logo"> <img
								src="/PCsell/resources/img/logo.png" alt="">
							</a>
						</div>
					</div>
					<!-- /LOGO -->
				...
				<form action="productWrite" method="post"
					...
					<div class="col-md-5">
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="Interface"
									placeholder="인터페이스">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="input" type="tel" name="price" placeholder="*가격"
									required>
							</div>
							<div class="form-group">
								<input class="input" type="tel" name="count" placeholder="수량">
							</div>
							<div class="form-group">
